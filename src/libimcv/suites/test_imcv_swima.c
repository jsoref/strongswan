...
static pen_type_t ita_data_model = { PEN_ITA, 0xFF };
...
static sw_inv_data_t sw_inv_data[] = {
	{ IETF_SWIMA_ATTR_SW_INV_FLAG_NONE, 0xFF, 0xFF, 0xFF,
	  chunk_from_chars(
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	...
	{ IETF_SWIMA_ATTR_SW_INV_FLAG_S_F, 0xFF, 0xFF, 0xFF,
	  chunk_from_chars(
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
START_TEST(test_imcv_swima_inv)
{
	...
	for (n = 0; n < _i/2; n++)
	{
		...
		{
			sw_record->set_data_model(sw_record, ita_data_model);
			sw_record->set_source_id(sw_record, 0xFF);
		}
		if (!sw_id_only)
		{
	...
	while (enumerator->enumerate(enumerator, &sw_record))
	{
		...
		ck_assert(source_id == (n == 1 ? 0xFF : 0xFF));
		n++;
	}
	enumerator->destroy(enumerator);
	ck_assert(n == _i/2);
...
static sw_ev_data_t sw_ev_data[] = {
	{ IETF_SWIMA_ATTR_SW_EV_FLAG_NONE, 0xFF, 0xFF, 0xFF,
	  0xFF, chunk_from_chars(
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF)
	},
	{ IETF_SWIMA_ATTR_SW_EV_FLAG_NONE, 0xFF, 0xFF, 0xFF,
	...
	{ IETF_SWIMA_ATTR_SW_EV_FLAG_NONE, 0xFF, 0xFF, 0xFF,
	  0xFF, chunk_from_chars(
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF,  '2',  '0',  '1',  '7',  '-',  '0',
		 '5',  '-',  '3',  '0',  'T',  '1',  '8',  ':',  '0',  '9',
		 ':',  '2',  '5',  'Z', 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
	...
	{ IETF_SWIMA_ATTR_SW_EV_FLAG_S_F, 0xFF, 0xFF, 0xFF,
	  0xFF, chunk_from_chars(
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF,  '2',  '0',  '1',  '7',  '-',  '0',
		...
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,  '2',  '0',  '1',  '7',
		 '-',  '0',  '6',  '-',  '1',  '4',  'T',  '1',  '5',  ':',
		 '3',  '8',  ':',  '0',  '0',  'Z', 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	...
	{ IETF_SWIMA_ATTR_SW_EV_FLAG_S_F, 0xFF, 0xFF, 0xFF,
	  0xFF, chunk_from_chars(
		...
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,	0xFF, 0xFF,
		0xFF, 0xFF, 0xFF,  '2',  '0',  '1',  '7', '-',   '0',  '6',
		 '-',  '1',  '4',  'T',  '1',  '5',  ':', '3',  '8',  ':',
		 '0',  '0',  'Z', 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
START_TEST(test_imcv_swima_ev)
{
	...
	{
		ck_assert(sw_event->get_eid(sw_event, &timestamp) == 0xFF + 4 * n);
