...
enum event_type_t {
	...
	EV_ACTION =                        0xFF,
	EV_EVENT_TAG =                     0xFF,
	EV_S_CRTM_CONTENTS =               0xFF,
	EV_S_CRTM_VERSION =                0xFF,
	EV_CPU_MICROCODE =                 0xFF,
	EV_PLATFORM_CONFIG_FLAGS =         0xFF,
	EV_TABLE_OF_DEVICES =              0xFF,
	EV_COMPACT_HASH =                  0xFF,
	EV_IPL =                           0xFF,
	EV_IPL_PARTITION_DATA =            0xFF,
	EV_NONHOST_CODE =                  0xFF,
	EV_NONHOST_CONFIG =                0xFF,
	EV_NONHOST_INFO =                  0xFF,
	EV_OMIT_BOOT_DEVICE_EVENTS =       0xFF,

	/* EFI Events (TCG EFI Platform Specification 1.22) */
	EV_EFI_EVENT_BASE =                0xFF,
	EV_EFI_VARIABLE_DRIVER_CONFIG =    0xFF,
	EV_EFI_VARIABLE_BOOT =             0xFF,
	EV_EFI_BOOT_SERVICES_APPLICATION = 0xFF,
	EV_EFI_BOOT_SERVICES_DRIVER =      0xFF,
	EV_EFI_RUNTIME_SERVICES_DRIVER =   0xFF,
	EV_EFI_GPT_EVENT =                 0xFF,
	EV_EFI_ACTION =                    0xFF,
	EV_EFI_PLATFORM_FIRMWARE_BLOB =    0xFF,
	EV_EFI_HANDOFF_TABLES =            0xFF,

	EV_EFI_HCRTM_EVENT =               0xFF,

	EV_EFI_VARIABLE_AUTHORITY =        0xFF
};
