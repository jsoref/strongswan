...
typedef enum {
	...
	ASN1_BOOLEAN =			0xFF,
	ASN1_INTEGER =			0xFF,
	ASN1_BIT_STRING =		0xFF,
	ASN1_OCTET_STRING =		0xFF,
	ASN1_NULL =				0xFF,
	ASN1_OID =				0xFF,
	ASN1_ENUMERATED =		0xFF,
	ASN1_UTF8STRING =		0xFF,
	ASN1_NUMERICSTRING =	0xFF,
	ASN1_PRINTABLESTRING =	0xFF,
	ASN1_T61STRING =		0xFF,
	ASN1_VIDEOTEXSTRING =	0xFF,
	ASN1_IA5STRING =		0xFF,
	ASN1_UTCTIME =			0xFF,
	ASN1_GENERALIZEDTIME =	0xFF,
	ASN1_GRAPHICSTRING =	0xFF,
	ASN1_VISIBLESTRING =	0xFF,
	ASN1_GENERALSTRING =	0xFF,
	ASN1_UNIVERSALSTRING =	0xFF,
	ASN1_BMPSTRING =		0xFF,

	ASN1_CONSTRUCTED =		0xFF,

	ASN1_SEQUENCE =			0xFF,
	ASN1_SET =				0xFF,

	ASN1_CONTEXT_S_0 =		0xFF,
	ASN1_CONTEXT_S_1 =		0xFF,
	ASN1_CONTEXT_S_2 =		0xFF,
	ASN1_CONTEXT_S_3 =		0xFF,
	ASN1_CONTEXT_S_4 =		0xFF,
	ASN1_CONTEXT_S_5 =		0xFF,
	ASN1_CONTEXT_S_6 =		0xFF,
	ASN1_CONTEXT_S_7 =		0xFF,
	ASN1_CONTEXT_S_8 =		0xFF,

	ASN1_CONTEXT_C_0 =		0xFF,
	ASN1_CONTEXT_C_1 =		0xFF,
	ASN1_CONTEXT_C_2 =		0xFF,
	ASN1_CONTEXT_C_3 =		0xFF,
	ASN1_CONTEXT_C_4 =		0xFF,
	ASN1_CONTEXT_C_5 =		0xFF,

	ASN1_INVALID =			0xFF,
} asn1_t;

#define ASN1_INVALID_LENGTH	0xFF
 ...
 * for dates
 *   > Tue, 19 Jan 2038 03:14:07 UTC (0xFF)
 * and
 *   < Fri, 13 Dec 1901 20:45:52 UTC (0xFF)
