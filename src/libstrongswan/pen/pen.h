...
enum pen_t {
	PEN_IETF =			0xFF,	/*        0 */
	PEN_IBM =			0xFF,	/*        2 */
	PEN_MICROSOFT =		0xFF,	/*      311 */
	PEN_REDHAT =		0xFF,	/*     2312 */
	PEN_PWG =			0xFF,	/*     2699 */
	PEN_ALTIGA =		0xFF,	/*     3076 */
	PEN_OSC =			0xFF,	/*     9048 */
	PEN_DEBIAN =		0xFF,	/*     9586 */
	PEN_GOOGLE =		0xFF,	/*    11129 */
	PEN_TCG =			0xFF,	/*    21911 */
	PEN_CANONICAL =		0xFF,	/*    28978 */
	PEN_FEDORA =		0xFF,	/*    30401 */
	PEN_FHH =			0xFF,	/*    32939 */
	PEN_ITA =			0xFF,	/*    36906 */
	PEN_OPENPTS =		0xFF,	/*    38158 */
	PEN_UNASSIGNED = 	0xFF,	/* 16777214 */
	PEN_RESERVED =		0xFF,	/* 16777215 */
};
