...
asn1_test_t length_tests[] = {
	{ FALSE, 0, { NULL, 0 } },
	{ FALSE, 0, chunk_from_chars(0xFF) },
	{ TRUE,  1, chunk_from_chars(0xFF, 0xFF) },
	{ TRUE,  1, chunk_from_chars(0xFF, 0xFF, 0xFF) },
	{ FALSE, 0, chunk_from_chars(0xFF, 0xFF) },
	{ FALSE, 0, chunk_from_chars(0xFF, 0xFF) },
	{ FALSE, 0, chunk_from_chars(0xFF, 0xFF) },
	{ TRUE,  1, chunk_from_chars(0xFF, 0xFF, 0xFF) },
	{ FALSE, 0, chunk_from_chars(0xFF, 0xFF, 0xFF) },
	{ TRUE,  1, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF) },
	{ FALSE, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF) },
	{ TRUE,  1, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ FALSE, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ TRUE,  1, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ FALSE, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ TRUE,  1, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
};
...
asn1_test_t loop_tests[] = {
	{ TRUE,  0, chunk_from_chars(0xFF, 0xFF) },
	{ FALSE, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF) },
	{ TRUE,  1, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ TRUE,  2, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ FALSE, 1, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ TRUE,  3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											 0xFF, 0xFF, 0xFF, 0xFF) },
};
...
default_opt_test_t default_tests[] = {
	{ -1, -2, -3, chunk_from_chars(0xFF, 0xFF) },
	{  1, -2, -3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ -1,  2, -3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ -1, -2,  3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{  1,  2, -3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF) },
	{  1, -2,  3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	...
	{  1,  2,  3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF) },
	{  0,  0,  0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF) },
	{  1,  0,  0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF) },
	{  1,  2,  0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF,
											   0xFF, 0xFF, 0xFF) },
};
...
default_opt_test_t option_tests[] = {
	{ 0, 0, 0, chunk_from_chars(0xFF, 0xFF) },
	{ 1, 0, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 0, 2, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 0, 0, 3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 1, 2, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											0xFF, 0xFF, 0xFF) },
	{ 1, 0, 3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											0xFF, 0xFF, 0xFF) },
	{ 0, 2, 3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											0xFF, 0xFF, 0xFF) },
	{ 1, 2, 3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
											0xFF, 0xFF, 0xFF,
											0xFF, 0xFF, 0xFF) },
	{ 0, 2, 3, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF,
											0xFF, 0xFF, 0xFF,
											0xFF, 0xFF, 0xFF) },
};
...
choice_test_t choice_tests[] = {
	{ 0, 0, 0, 0, { NULL, 0 } },
	{ 0, 0, 0, 0, chunk_from_chars(0xFF, 0xFF) },
	{ 1, 0, 0, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 1, 0, 0, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	                                           0xFF, 0xFF, 0xFF) },
	{ 0, 2, 0, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 0, 2, 0, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	                               0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 0, 0, 0, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 0, 0, 3, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 0, 0, 0, 4, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 0, 0, 3, 4, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	                                           0xFF, 0xFF, 0xFF) },
	{ 0, 0, 3, 4, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	                                           0xFF, 0xFF, 0xFF) },
	{ 0, 0, 6, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	                                           0xFF, 0xFF, 0xFF) },
	{ 0, 0, 0, 8, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	                                           0xFF, 0xFF, 0xFF) },
	{ 0, 0, 0, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF) },
	{ 0, 0, 0, 0, chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF) }
};
