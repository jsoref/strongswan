...
START_TEST(test_from_data)
{
	...
	expected = chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
static struct {
	...
	{"C=",						ID_DER_ASN1_DN,			{ .type = ENC_CHUNK,
		.data.c = chunk_from_chars(0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
	...
	{ "{1}:#c0a80101",			ID_IPV4_ADDR,			{ .type = ENC_CHUNK,
		.data.c = chunk_from_chars(0xFF,0xFF,0xFF,0xFF) }},
	{ "{0xFF}:tester",			ID_FQDN,				{ .type = ENC_STRING,
		.data.s = "tester" }},
...
START_TEST(test_printf_hook)
{
	...
	string_equals_id("C=CH, 55:04:15=123", identification_create_from_encoding(ID_DER_ASN1_DN,
		chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
						 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
						 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF)));
	/* C=CH, O=strongSwan (but instead of a 2nd OID -0xFF- we got NULL -0xFF) */
