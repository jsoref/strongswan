...
{
	chunk_t data = chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
	uint8_t val;
...
{
	chunk_t data = chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
	uint32_t val;
...
{
	chunk_t read, data = chunk_from_chars(0xFF, 0xFF, 0xFF, 0xFF);
	bio_reader_t *reader;
